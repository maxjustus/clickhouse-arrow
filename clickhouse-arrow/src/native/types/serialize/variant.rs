...
mod tests {
    use super::*;
    use std::io::Cursor;
    use crate::native::types::deserialize::{variant::VariantDeserializer, ClickHouseNativeDeserializer};
    ...
    fn test_variant_serialization_homogeneous() {
        ...
        // Read values
        let deserialized = VariantDeserializer::read_sync(&variant_type, &mut reader, 5, &mut deser_state).unwrap();
    ...
    fn test_variant_serialization_sparse() {
        ...
        let values = vec![
            ...
            Value::Variant(2, Box::new(Value::Float64(3.14))),               // Float64
            Value::Variant(1, Box::new(Value::Date(Date(19723)))),           // Date
            Value::Variant(0, Box::new(Value::Array(vec![                    // Array(Int32)
                Value::Int32(1),
                Value::Int32(2),
            ]))),
        ...
        // Read values
        let deserialized = VariantDeserializer::read_sync(&variant_type, &mut reader, 8, &mut deser_state).unwrap();
    ...
    fn test_variant_serialization_with_nested_types() {
        ...
        let values = vec![
            ...
            Value::Variant(0, Box::new(Value::Array(vec![                    // Array(Nullable(UInt64))
                Value::UInt64(100),
                Value::Null,
                Value::UInt64(200),
            ]))),
            Value::Variant(2, Box::new(Value::Tuple(vec![                    // Tuple
    ...
    fn test_variant_empty_values() {
        ...
        // Read values
        let deserialized = VariantDeserializer::read_sync(&variant_type, &mut reader, 0, &mut deser_state).unwrap();
    ...
    fn test_variant_all_nulls() {
        ...
        // Read values
        let deserialized = VariantDeserializer::read_sync(&variant_type, &mut reader, 4, &mut deser_state).unwrap();
