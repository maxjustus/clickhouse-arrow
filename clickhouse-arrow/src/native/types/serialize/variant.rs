...
//     pub(crate) async fn write_prefix<W: ClickHouseWrite>(...) -> Result<()>
//     pub(crate) async fn write<W: ClickHouseWrite>(...) -> Result<()>
//     pub(crate) fn write_sync<W: ClickHouseBytesWrite>(...) -> Result<()>
// }