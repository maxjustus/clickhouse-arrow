...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    client.execute("CREATE TABLE IF NOT EXISTS test_sparse (id UInt64, sparse_text String) ENGINE = MergeTree ORDER BY id", None).await?;
